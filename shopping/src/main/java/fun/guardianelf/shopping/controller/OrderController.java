...
public class OrderController extends BaseController
{
     ...
     * 查询订单列表
     */
    @PreAuthorize("@ss.hasPermi('shopping:order:list')")
    @GetMapping("/list")
     ...
     * 导出订单列表
     */
    @PreAuthorize("@ss.hasPermi('shopping:order:export')")
     ...
     * 获取订单详细信息
     */
    @PreAuthorize("@ss.hasPermi('shopping:order:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增订单
     */
    @PreAuthorize("@ss.hasPermi('shopping:order:add')")
     ...
     * 修改订单
     */
    @PreAuthorize("@ss.hasPermi('shopping:order:edit')")
